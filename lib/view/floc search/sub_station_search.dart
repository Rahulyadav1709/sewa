...
class _FLOCOperationState extends State<FLOCOperation>
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildInfoSection(
                      'What is FLOC?',
                      'FLOC (Functional Location) is a hierarchical system used to identify and organize physical locations of equipment or assets within a facility.',
                    ),
                    const SizedBox(height: 16),
                    buildInfoSection(
                      'How to use',
                      'Use the search bar to find specific FLOC IDs. Tap on any FLOC to view detailed information and related equipment.',
                    ),
                    const SizedBox(height: 16),
                    buildInfoSection(
                      'Filtering',
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              setState(() {
                controller.getFlocIdsFuture = controller.getFlocInfoApi();
              });
            },
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search for Sub-Station...',
  ...
  Widget buildFlocInfoCard() {
    return Obx(() {
      if (controller.filteredFLOCEntries.isEmpty) {
        return Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return AnimatedBuilder(
            ...
            child: buildFlocCard(entry, index),
          );
        },
      );
    });
  ...
  Widget buildFlocCard(MapEntry<String, int> entry, int index) {
            ...
            PageRouteBuilder(
              pageBuilder:
                  (context, animation, secondaryAnimation) =>
                      FlocSearchResultScreen(flocID: entry.key.toUpperCase()),
              transitionsBuilder: (
                context,
                animation,
                secondaryAnimation,
